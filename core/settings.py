...
#os.getenv():luôn trả về string ko phải boolean
# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = os.getenv(
    "SECRET_KEY",
    "dev-only-secret-key-change-before-production-123456",
)
...
INSTALLED_APPS = [
    ...
    'django_filters',
    'drf_spectacular', #Tạo tài liệu API OpenAPI/Swagger.
    'app_movies',
]
...
SPECTACULAR_SETTINGS = {
    "TITLE":"Movies API",
    "DESCRIPTION": (
        "API quản lý phim, phân quyền theo chủ sỡ hữu va đánh giá theo user."
    ),
    "VERSION":"1.0.0",
